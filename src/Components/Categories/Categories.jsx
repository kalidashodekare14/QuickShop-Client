...
const Categories = () => {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-5 m-5'>
            <div className='bg-[#f6f8fa]  p-5 flex flex-col justify-center items-center hover:text-[#00bba6] hover:bg-[#00bba525] duration-150 cursor-pointer'>
